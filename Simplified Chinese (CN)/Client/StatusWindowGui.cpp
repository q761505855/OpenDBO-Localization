...
VOID CStatusAvatarTab::HandleEvents( RWS::CMsg& msg )
{
	...
	if( msg.Id == g_EventSobInfoUpdate )
	{
		...
		if( pUpdate->uiUpdateType & EVENT_AIUT_ATTR )
		{
			...
			// 酒官鸥狼 Attribute ( Battle Attribute bonus ) 啊 诀单捞飘 登搁 促矫 拌魂秦霖促.
			CalcBattleAttribute();
...
//	pNode->Expand( true );
//
//	pNode = NTL_NEW CStatusHonorContent( this, L"疙抗痢荐 : 9999999999", 10 );
...
//	pNode->Expand( true );
//
//	pNode = NTL_NEW CStatusHonorContent( this, L"珐农器牢飘 : 99999999", 11 );
...
RwBool CStatusStatsTab::Create(CNtlPLGui* pParent)
{
	...
	m_pOutDisplayStatsName->AddText(L"力量:");
	m_pOutDisplayStatsName->AddText(L"耐力:");
	m_pOutDisplayStatsName->AddText(L"集中:");
	m_pOutDisplayStatsName->AddText(L"敏捷:");
	m_pOutDisplayStatsName->AddText(L"气合:");
	m_pOutDisplayStatsName->AddText(L"幸运:");
	m_pOutDisplayStatsName->AddText(L"LP恢复:");
	m_pOutDisplayStatsName->AddText(L"坐下时LP恢复:");
	m_pOutDisplayStatsName->AddText(L"战斗中LP恢复:");
	m_pOutDisplayStatsName->AddText(L"EP恢复:");
	m_pOutDisplayStatsName->AddText(L"坐下时EP恢复:");
	m_pOutDisplayStatsName->AddText(L"战斗中EP恢复:");
	m_pOutDisplayStatsName->AddText(L"AP恢复:");
	m_pOutDisplayStatsName->AddText(L"坐下时AP恢复:");
	m_pOutDisplayStatsName->AddText(L"AP消耗:");
	m_pOutDisplayStatsName->AddText(L"RP蓄力速度:");
	m_pOutDisplayStatsName->AddText(L"RP衰减:");
	m_pOutDisplayStatsName->AddText(L"格斗攻击力:");
	m_pOutDisplayStatsName->AddText(L"格斗防御力:");
	m_pOutDisplayStatsName->AddText(L"气功攻击力:");
	m_pOutDisplayStatsName->AddText(L"气功防御力:");
	m_pOutDisplayStatsName->AddText(L"格斗护甲穿透率:");
	m_pOutDisplayStatsName->AddText(L"气功护甲穿透率:");
	m_pOutDisplayStatsName->AddText(L"命中率:");
	m_pOutDisplayStatsName->AddText(L"回避率:");
	m_pOutDisplayStatsName->AddText(L"格挡率:");
	m_pOutDisplayStatsName->AddText(L"格挡伤害减免率:");
	m_pOutDisplayStatsName->AddText(L"状态异常成功率:");
	m_pOutDisplayStatsName->AddText(L"状态异常抵抗率:");
	m_pOutDisplayStatsName->AddText(L"格斗暴击率:");
	m_pOutDisplayStatsName->AddText(L"气功暴击率:");
	m_pOutDisplayStatsName->AddText(L"格斗暴击伤害率:");
	m_pOutDisplayStatsName->AddText(L"气功暴击伤害率:");
	m_pOutDisplayStatsName->AddText(L"步行速度:");
	m_pOutDisplayStatsName->AddText(L"奔跑速度:");
	m_pOutDisplayStatsName->AddText(L"飞行速度:");
	m_pOutDisplayStatsName->AddText(L"飞行冲刺速度:");
	m_pOutDisplayStatsName->AddText(L"飞行加速速度:");
	m_pOutDisplayStatsName->AddText(L"攻击速度:");
	m_pOutDisplayStatsName->AddText(L"攻击距离:");
	m_pOutDisplayStatsName->AddText(L"施放时间修正:");
	m_pOutDisplayStatsName->AddText(L"冷却时间修正:");
	m_pOutDisplayStatsName->AddText(L"持续时间修正:");
	m_pOutDisplayStatsName->AddText(L"持续伤害时间修正:");
	m_pOutDisplayStatsName->AddText(L"EP消耗修正:");
	m_pOutDisplayStatsName->AddText(L"格斗伤害反射:");
	m_pOutDisplayStatsName->AddText(L"气功伤害反射:");
	m_pOutDisplayStatsName->AddText(L"麻痹抵抗率:");
	m_pOutDisplayStatsName->AddText(L"恐惧抵抗率:");
	m_pOutDisplayStatsName->AddText(L"混乱抵抗率:");
	m_pOutDisplayStatsName->AddText(L"石化抵抗率:");
	m_pOutDisplayStatsName->AddText(L"糖果化抵抗率:");
	m_pOutDisplayStatsName->AddText(L"麻痹持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"恐惧持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"混乱持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"石化持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"糖果化持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"出血持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"中毒持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"腹痛持续时间缩短:");
	m_pOutDisplayStatsName->AddText(L"暴击格挡率:");
	m_pOutDisplayStatsName->AddText(L"受击时LP恢复:");
	m_pOutDisplayStatsName->AddText(L"受击时LP恢复率:");
	m_pOutDisplayStatsName->AddText(L"受击时EP恢复:");
	m_pOutDisplayStatsName->AddText(L"受击时EP恢复率:");
	m_pOutDisplayStatsName->AddText(L"腹痛防御:");
	m_pOutDisplayStatsName->AddText(L"中毒防御:");
	m_pOutDisplayStatsName->AddText(L"出血防御:");
	m_pOutDisplayStatsName->AddText(L"灼烧防御:");
	m_pOutDisplayStatsName->AddText(L"精神类异常免疫率:");
	m_pOutDisplayStatsName->AddText(L"身体类异常免疫率:");
	m_pOutDisplayStatsName->AddText(L"变身类异常免疫率:");
	m_pOutDisplayStatsName->AddText(L"技能动画速度:");
	m_pOutDisplayStatsName->AddText(L"负重上限:");
	m_pOutDisplayStatsName->AddText(L"仇恨值加成:");
	m_pOutDisplayStatsName->AddText(L"仇恨值加成率:");
	m_pOutDisplayStatsName->AddText(L"治疗量加成:");
	m_pOutDisplayStatsName->AddText(L"治疗量加成率:");
	m_pOutDisplayStatsName->AddText(L"持续治疗量加成:");
	m_pOutDisplayStatsName->AddText(L"持续治疗量加成率:");
	m_pOutDisplayStatsName->AddText(L"持续伤害加成率:");
	m_pOutDisplayStatsName->AddText(L"防御成功率:");
	m_pOutDisplayStatsName->AddText(L"技能伤害格挡率:");
	m_pOutDisplayStatsName->AddText(L"状态异常格挡率:");
	m_pOutDisplayStatsName->AddText(L"击倒格挡率:");
	m_pOutDisplayStatsName->AddText(L"HTB格挡率:");
	m_pOutDisplayStatsName->AddText(L"道具强化成功率:");
	m_pOutDisplayStatsName->AddText(L"经验值加成率:");
	m_pOutDisplayStatsName->AddText(L"任务道具掉落率:");
...
VOID CStatusWindowGui::SetBasicUISetting(VOID)
{
	...
	// temporary
	std::wstring wstrStatsTitle = L"属性";
